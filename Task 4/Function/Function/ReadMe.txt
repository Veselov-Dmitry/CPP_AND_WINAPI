========================================================================
    ACTIVE TEMPLATE LIBRARY : Function Project Overview
========================================================================

AppWizard has created this Function project for you to use as the starting point for
...
Function.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (Function.h)
        GUID definitions                                (Function_i.c)
        A type library                                  (Function.tlb)
        Marshaling code                                 (Function_p.c and dlldata.c)

Function.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in Function.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named Function.pch and a precompiled types file named StdAfx.obj.
...
Functionps.vcxproj
	...
	dlldata.c, Function_i.c and Function_p.c which are required
	to build the proxy/stub DLL.

Functionps.vcxproj.filters
