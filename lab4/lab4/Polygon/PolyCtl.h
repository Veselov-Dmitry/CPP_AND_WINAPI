...
#endif
	public IProvideClassInfo2Impl<&CLSID_CoPolyCtl, &__uuidof(_IPolyCtlEvents), &LIBID_PolygonLib>,
	public CComCoClass<CPolyCtl, &CLSID_CoPolyCtl>,
	public CComControl<CPolyCtl>,
	public IObjectSafetyImpl<CPolyCtl, INTERFACESAFE_FOR_UNTRUSTED_CALLER>	// безопасный для сценариев

{
public:

	POINT m_arrPoint[10];					// массив точек
	short m_nSides;
	CPolyCtl()								// конструктор
	{
		m_nSides = 3;						// количестов сторон
		m_clrFillColor = RGB(0, 0xFF, 0);	// цвет заливки
	}
...
BEGIN_PROP_MAP(CPolyCtl) 
   ...
   //PROP_ENTRY("FillColor", DISPID_FILLCOLOR, CLSID_StockColorPage)
   PROP_ENTRY("Sides", 1, CLSID_PolyProp)		 // добавление страницы свойст
   //PROP_ENTRY("Sides2",1,CLSID_PolyProp)
   // Example entries
